...
import (
	...
	"k8s.io/gengo/args"
	gengoconversiongen "k8s.io/gengo/examples/conversion-gen/generators"
...
func NameSystems() namer.NameSystems {
	return namer.NameSystems{
		"conversion": gengoconversiongen.ConversionNamer(),
	}
}
...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	scopeVar := gengoconversiongen.NewNamedVariable(scopeVarName, types.Ref(conversionPackagePath, "Scope"))
	manualConversionsTracker := gengoconversiongen.NewManualConversionsTracker(scopeVar)
	...
	for _, i := range context.Inputs {
		...
		conversionGenerator, err := gengoconversiongen.NewConversionGenerator(context, arguments.OutputFileBaseName, typesPkg.Path, pkg.Path, peerPkgs, manualConversionsTracker)
		if err != nil {
...
func externalConversionsHandler(inVar, outVar gengoconversiongen.NamedVariable, sw *generator.SnippetWriter) error {
...
type genConversion struct {
	*gengoconversiongen.ConversionGenerator
...
func samePkgManualConversionPairs(manualConversions map[gengoconversiongen.ConversionPair]*types.Type, outputPackage string) (pairs []gengoconversiongen.ConversionPair) {
